...
저는 계정이 ChoiChaJang입니다. 그래서 다음과 같은 저장소를 만들었습니다.
...
5. 소스 전체 복사하기
6. 내 저장소 루트에서 'Create new File' 눌러 _config.yml 파일 생성하기
...
'9. 네비게이션 만들고 자기 소개페이지 수정하기'는 네이게이션 파일을 만들고 자기소개 파일을 만들면 그만입니다.
...
그후 저장소 루트에 about.md 파일을 생성합니다. 내용은 원하시는 대로 하시면 됩니다.
